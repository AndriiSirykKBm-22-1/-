...
class KhokhlovNeuralNetwork:
	...
	epochs = 1000 
	# кількість циклів у всьому наборі даних 
	for epoch in range(epochs):
		for x, y_true in zip(data, all_y_trues):
			# --- Виконуємо зворотній зв'язок (ці значання нам потрібні в по-дальшому )
			...
			# --- Найменування: d_L_d_w1 означає "частково L / частково w1" d_L_d_ypred = -2 * (y_true - y_pred)
			# Нейрон o1
			...
			# --- Оновлюємо вагу і зміщення # Нейрон h1
